                    ...
                    <div className="flex-1 p-4 sm:p-8 bg-gray-200 flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-end w-full max-w-6xl">
                            ...
                            <div>
                                ...
                                {/* "Add Customer" button */}
                                <button className="mb-4 ml-2 px-10 py-1 border-2 border-red-900 text-black rounded-lg self-end bg-transparent shadow-lg">Add Guest</button>
                            </div>
                            {/* Card */}
                            <div className="bg-white p-4 sm:p-8 shadow-md rounded-md w-full">
                                <div className="flex justify-between">
                                    ...
                                    {/* Conditional rendering based on isTableView */}
                                    {isTableView ? (
                                        <div className="flex items-center">
                                            <button className="flex items-center bg-red-900 text-white px-4 py-2 rounded-lg shadow-lg"
                        ...
                        <div className="fixed top-0 right-0 h-full w-6/12 bg-white shadow-lg p-4 z-40 transition-transform transform translate-x-0 overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                            <div className="flex flex-col mt-20">
                                ...
                                <div className="bg-white px-4 rounded-md w-full">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                        <div className="flex flex-col">
                                            <div className="flex items-center mb-2">
                                                ...
                                                <h2 className="text-4xl font-bold mb-1">Table {selectedTable}</h2>
                                            </div>
                                            <div className="flex items-center">
                                                <div className="bg-gray-200 px-2 rounded-xl font-bold">G</div>
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            <button className="mb-4 mt-2 ml-2 px-10 py-1 border-2 border-red-900 text-black rounded-lg self-end bg-transparent shadow-xl">Load Wallet</button>
                                        </div>
                                    </div>
                                    ...
                                    {/* Conditionally render content below the divider */}
                                    {isCreatingOrder ? (
                                        <div>
                                            <div className="overflow-x-auto mb-4">
                                                <div className="relative">
                                                    ...
                                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                                                            <path fillRule="evenodd" d="M12.9 14.32a8 8 0 111.42-1.42l4.7 4.7a1 1 0 11-1.42 1.42l-4.7-4.7zM8 14a6 6 0 100-12 6 6 0 000 12z" clipRule="evenodd" />
                                                        </svg>
                                                    </div>
                                                </div>
                                        ...
                                        <>
                                            <div className="flex justify-between items-center mb-4">
                                                ...
                                                <button className="flex items-center bg-red-900 text-white px-4 py-2 rounded-2xl shadow-lg" onClick={handleCreateOrderClick}>
                                                    <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M6.52889 0V6.5M6.52889 13V6.5M6.52889 6.5H0H13" stroke="white" />
                                                    </svg>
                                                    <span className="ml-2">Create Order</span>
                                                    ...
                                                    <tbody>
                                                        {Array.from({ length: 4 }).map((_, rowIndex) => (
                                                            <tr key={rowIndex} className="hover:bg-gray-100">
                                                                ...
                                                                <td className="px-4 py-2 border-b text-center">{9 * (8 + rowIndex)}</td>
                                                                <td className="px-4 py-2 border-b text-center">INR 450.00</td>
                                                                <td className="px-4 py-2 border-b text-center" onClick={isTableView}>
                                                                    <svg width="39" height="20" viewBox="0 0 39 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M23.5455 1L37 10M37 10L23.5455 19M37 10H0" stroke="black" stroke-width="2" />
                                                                    </svg>
                                                                </td>
